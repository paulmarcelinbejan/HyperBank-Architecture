...
declareInputFiles() {
    ...
    SaveRequestValidatorImplTemplate="${SCRIPT_DIRECTORY}/${TEMPLATE_FOLDER}/${API_FOLDER}/save/one/SaveRequestValidatorImplTemplate.java"
    SaveRequestValidatorTemplate="${SCRIPT_DIRECTORY}/${TEMPLATE_FOLDER}/${API_FOLDER}/save/one/SaveRequestValidatorTemplate.java"
    ...
    SaveRequestsValidatorImplTemplate="${SCRIPT_DIRECTORY}/${TEMPLATE_FOLDER}/${API_FOLDER}/save/many/SaveRequestsValidatorImplTemplate.java"
    SaveRequestsValidatorTemplate="${SCRIPT_DIRECTORY}/${TEMPLATE_FOLDER}/${API_FOLDER}/save/many/SaveRequestsValidatorTemplate.java"
    ...
    UpdateRequestValidatorImplTemplate="${SCRIPT_DIRECTORY}/${TEMPLATE_FOLDER}/${API_FOLDER}/update/one/UpdateRequestValidatorImplTemplate.java"
    UpdateRequestValidatorTemplate="${SCRIPT_DIRECTORY}/${TEMPLATE_FOLDER}/${API_FOLDER}/update/one/UpdateRequestValidatorTemplate.java"
    ...
    UpdateRequestsValidatorImplTemplate="${SCRIPT_DIRECTORY}/${TEMPLATE_FOLDER}/${API_FOLDER}/update/many/UpdateRequestsValidatorImplTemplate.java"
    UpdateRequestsValidatorTemplate="${SCRIPT_DIRECTORY}/${TEMPLATE_FOLDER}/${API_FOLDER}/update/many/UpdateRequestsValidatorTemplate.java"
    ...
    TEMPLATES=(
        ...
        "${SaveRequestValidatorImplTemplate}"
        "${SaveRequestValidatorTemplate}"
        ...
        "${SaveRequestsValidatorImplTemplate}"
        "${SaveRequestsValidatorTemplate}"
        ...
        "${UpdateRequestValidatorImplTemplate}"
        "${UpdateRequestValidatorTemplate}"
        ...
        "${UpdateRequestsValidatorImplTemplate}"
        "${UpdateRequestsValidatorTemplate}"
...
declareOutputFiles() {
    ...
    SaveRequestValidatorImplOutput="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${API_FOLDER}/save/one/${ENTITY}SaveRequestValidatorImpl.java"
    SaveRequestValidatorOutput="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${API_FOLDER}/save/one/${ENTITY}SaveRequestValidator.java"
    ...
    SaveRequestsValidatorImplOutput="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${API_FOLDER}/save/many/${ENTITY}SaveRequestsValidatorImpl.java"
    SaveRequestsValidatorOutput="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${API_FOLDER}/save/many/${ENTITY}SaveRequestsValidator.java"
    ...
    UpdateRequestValidatorImplOutput="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${API_FOLDER}/update/one/${ENTITY}UpdateRequestValidatorImpl.java"
    UpdateRequestValidatorOutput="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${API_FOLDER}/update/one/${ENTITY}UpdateRequestValidator.java"
    ...
    UpdateRequestsValidatorImplOutput="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${API_FOLDER}/update/many/${ENTITY}UpdateRequestsValidatorImpl.java"
    UpdateRequestsValidatorOutput="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${API_FOLDER}/update/many/${ENTITY}UpdateRequestsValidator.java"
    ...
    OUTPUTS=(
        ...
        "${UpdateRequestValidatorImplOutput}"
        ...
        "${UpdateRequestsValidatorImplOutput}"
        "${UpdateRequestsValidatorOutput}"
